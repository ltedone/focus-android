...
public class IntentUtils {
    ...
    private static void showConfirmationDialog(final Activity activity, final Intent targetIntent, final String title, final @StringRes int messageResource, final CharSequence param) {
        ...
        builder.setPositiveButton(R.string.external_app_prompt_ok, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(R.string.external_app_prompt_cancel, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(final DialogInterface dialog, final int which) {
                dialog.dismiss();
            }
